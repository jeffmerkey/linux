...
extern unsigned long enterKeyACC(unsigned long key,
		void *stackFrame,
		ACCELERATOR *accel);
extern unsigned long activateRegisterDisplayACC(unsigned long key,
		void *stackFrame,
		ACCELERATOR *accel);

extern unsigned long displayDebuggerHelpHelp(unsigned char *commandLine,
...
extern unsigned long ascTableHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayToggleHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayDebuggerVersionHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayKernelQueueHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displaySymbolsHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayLoaderMapHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayModuleHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayProcessesHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayRegistersHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long ReasonHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayMPSHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long clearScreenHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long SearchMemoryHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long SearchMemoryD(unsigned char *cmd,
		...
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long SearchMemoryQ(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);

extern unsigned long changeMemoryHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayCloseHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayINTRHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long viewScreensHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayDumpHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long debuggerDumpQuadPhys(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long debuggerDumpDoublePhys(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long debuggerDumpWordPhys(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long debuggerDumpBytePhys(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);


extern unsigned long displayDisassembleHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long rebootSystemHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
extern unsigned long rebootSystem(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);

extern unsigned long displaySectionsHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long backTraceHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
extern unsigned long backTraceAllPID(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long backTracePID(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long backTraceStack(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
...
extern unsigned long displayProcessSwitchHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
...
extern unsigned long percpuHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
extern unsigned long perCpu(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);

#if defined(CONFIG_MODULES)
extern unsigned long listModulesHelp(unsigned char *commandLine,
		DEBUGGER_PARSER *parser);
extern unsigned long listModules(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
extern unsigned long unloadModule(unsigned char *cmd,
		StackFrame *stackFrame,
		unsigned long Exception,
		DEBUGGER_PARSER *parser);
#endif
